...
export interface GetBatchErrorsResponse
	extends Pick<PaginatedResponse, "links"> {
	/** Batch Errors */
...
export type RemoveFromBatchOptions = Required<
	Pick<CreateBatchOptions, "shipment_ids">
> &
