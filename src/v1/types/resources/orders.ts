...
export interface ListOrdersByTagOptions
	extends Omit<PaginatedRequest, "sortDir"> {
	/** The order's status. */
	orderStatus: OrderStatus;
	/**
	 * The ID of the tag.
...
export interface CreateOrUpdateMultipleOrdersResponseItem
	extends Pick<Order, "orderId" | "orderNumber" | "orderKey"> {
	success: boolean;
